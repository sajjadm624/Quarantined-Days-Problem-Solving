...
def numToArray(num):
	...
	numArray[0] = int(num/100000000)%10 	#Hundred Millions place
	numArray[1] = int(num/10000000)%10 	    #Ten Millions place
	numArray[2] = int(num/1000000)%10 	    #Millions place
	numArray[3] = int(num/100000)%10 	    #Hundred-thousands place
	numArray[4] = int(num/10000)%10 		#Ten-thousands place
	numArray[5] = int(num/1000)%10 	    	#Thousands place
	numArray[6] = int(num/100)%10 		    #Hundreds place
	numArray[7] = int(num/10)%10 		    #Tens place
	numArray[8] = int(num/1)%10 			#Ones place
	return numArray
...
def numToPlace(num):
	...
	if (num>=20 and num<=99):
		if (numArray[8]==0):
			...
			place += tens[int(num/10)] + ' ' + places[int(num%10)]
